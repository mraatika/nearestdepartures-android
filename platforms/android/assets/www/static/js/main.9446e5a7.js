...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_1_liners__ = __webpack_require__(24);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__icons_svg__ = __webpack_require__(145);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_css__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__index_css__);
// use offline-plugin when in production
if(false){require('offline-plugin/runtime').install();}Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["render"])(Object(__WEBPACK_IMPORTED_MODULE_0_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_1__app__["a" /* default */]),document.getElementById('app'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_fputils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_utils__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_header_header__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_footer_footer__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_departureslist_departureslist__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_departurefilter_departurefilter__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_errormessage_errormessage__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_addresssearch_addresssearch__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__utils_departurefetchmerge__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_locationservice__ = __webpack_require__(186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_addresssearchservice__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils_formaterror__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__constants_constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_common_accuracyindicator__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__app_css__ = __webpack_require__(190);
 ...
 */var allVehicleTypes=__WEBPACK_IMPORTED_MODULE_1__utils_fputils__["a" /* default */].values(__WEBPACK_IMPORTED_MODULE_13__constants_constants__["h" /* VEHICLE_TYPE */]);/**
 * Default app state
 * @type {Object}
 */var DEFAULT_STATE={loading:true,addressSearchTerm:'',error:null,filters:{range:__WEBPACK_IMPORTED_MODULE_13__constants_constants__["b" /* DEFAULT_RANGE */],vehicleTypes:allVehicleTypes}};/**
 * Function for filtering departures by type
 * @param {string[]} filters
 * @return {Function}
 */var filterDepartures=function filterDepartures(filters){return __WEBPACK_IMPORTED_MODULE_1__utils_fputils__["a" /* default */].filter(function(d){return filters.vehicleTypes.indexOf(d.vehicleType)>-1&&d.distance<filters.range&&d.realtimeDeparture>=Object(__WEBPACK_IMPORTED_MODULE_2__utils_utils__["c" /* getNowInSeconds */])();});};/**
 * @class App
 ...
 */var App=function(_Component){_inherits(App,_Component);/**
   ...
   */_createClass(App,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;this.findDeparturesByCurrentLocation();// batch departures in every x seconds
setInterval(function(){return _this2.batchDeparturesToState();},__WEBPACK_IMPORTED_MODULE_13__constants_constants__["a" /* BATCH_INTERVAL */]);}/**
   * Find location and then departures by location found
   */},{key:'findDeparturesByCurrentLocation',value:function findDeparturesByCurrentLocation(){var _this3=this;// find location
Object(__WEBPACK_IMPORTED_MODULE_10__services_locationservice__["a" /* findGPSLocation */])().then(function(location){// do a reverse geocoding
Object(__WEBPACK_IMPORTED_MODULE_11__services_addresssearchservice__["a" /* lookupAddress */])(location).then(function(address){_this3.setState({location:location,addressSearchTerm:address});// and finally fetch all departures
_this3.fetchDeparturesToState(location);}).catch(function(err){_this3.onError('Osoitteen haku ep\xE4onnistui: '+err.message+'!');});}).catch(function(err){return _this3.onError(Object(__WEBPACK_IMPORTED_MODULE_12__utils_formaterror__["b" /* default */])(__WEBPACK_IMPORTED_MODULE_12__utils_formaterror__["a" /* POSITION_ERROR */],err));});}/**
   * Fetch departures and add them to state. Apply filters and also set filtered result to state.
   * @param {Object} location
   * @param {number} location.latitude
   * @param {number} location.longitude
   */},{key:'fetchDeparturesToState',value:function fetchDeparturesToState(location){var _this4=this;var filters=this.state.filters;Object(__WEBPACK_IMPORTED_MODULE_9__utils_departurefetchmerge__["b" /* fetchDepartures */])(location,filters.vehicleTypes).then(this.afterDeparturesFetched.bind(this)).catch(function(err){console.error(err);_this4.onError('L\xE4ht\xF6jen haku ep\xE4onnistui: '+err.message+'!');});}/**
   * Batch departures and add them to state. Apply filters and also set filtered result to state.
   */},{key:'batchDeparturesToState',value:function batchDeparturesToState(){Object(__WEBPACK_IMPORTED_MODULE_9__utils_departurefetchmerge__["a" /* batchDepartures */])(this.state.departures).then(this.afterDeparturesFetched.bind(this)).catch(function(err){return console.error(err);});}/**
   * Set state after departures has been fetched/batched
   * @param {Object[]} departures
   */},{key:'afterDeparturesFetched',value:function afterDeparturesFetched(departures){this.setState({loading:false,departures:departures,filtered:filterDepartures(this.state.filters)(departures),departureUpdateTime:new Date()});}/**
   * Callback for filter button. Toggles filter state.
   * @param {string} type
   * @param {boolean} multiselect
   */},{key:'onFilterToggle',value:function onFilterToggle(type,multiselect){var filters=this.state.filters;var current=filters.vehicleTypes;var currentToggled=current.indexOf(type)>-1;var activeFilters=__WEBPACK_IMPORTED_MODULE_1__utils_fputils__["a" /* default */].ifThenElse(function(){return!!multiselect;},// if pressed with ctrl key
...
this.setState({filters:Object.assign({},filters,{vehicleTypes:activeFilters})},this.filterDeparturesToState.bind(this));}/**
   ...
   * @param {number} range
   */},{key:'onRangeChange',value:function onRangeChange(range){this.setState({filters:Object.assign({},this.state.filters,{range:range})},this.filterDeparturesToState.bind(this));}/**
   * Filter departures based on filters set on state
   */},{key:'filterDeparturesToState',value:function filterDeparturesToState(){var _state=this.state,departures=_state.departures,filters=_state.filters;var filtered=filterDepartures(filters)(departures);// filter departures and then sort
this.setState({filtered:filtered});}/**
   * Search coordinates for given address/poi/etc.
   * @param {string} [address]
   */},{key:'searchForAddress',value:function searchForAddress(_ref){var _this5=this;var _ref$searchTerm=_ref.searchTerm,searchTerm=_ref$searchTerm===undefined?'':_ref$searchTerm,location=_ref.location;this.setState({location:undefined,loading:true,addressSearchTerm:searchTerm});// stop location search if still running
Object(__WEBPACK_IMPORTED_MODULE_10__services_locationservice__["b" /* stopLocating */])();__WEBPACK_IMPORTED_MODULE_1__utils_fputils__["a" /* default */].ifThenElse(__WEBPACK_IMPORTED_MODULE_1__utils_fputils__["a" /* default */].isTruthy,// if location is given then search departures by location
this.fetchDeparturesToState.bind(this),__WEBPACK_IMPORTED_MODULE_1__utils_fputils__["a" /* default */].ifThenElse(function(){return searchTerm&&searchTerm.toLocaleLowerCase()!==__WEBPACK_IMPORTED_MODULE_13__constants_constants__["c" /* LOCATION_MAGIC_WORD */];},// search address by search term
function(){Object(__WEBPACK_IMPORTED_MODULE_11__services_addresssearchservice__["b" /* searchAddress */])(searchTerm).then(function(result){var _result$=result[0],location=_result$.location,label=_result$.label;_this5.setState({addressSearchTerm:label,location:location});_this5.fetchDeparturesToState(location);}).catch(function(err){return _this5.onError('Osoitteen haku ep\xE4onnistui: '+err.message+'!');});},// if location and search term is empty then search by client location
this.findDeparturesByCurrentLocation.bind(this)))(location);}},{key:'clearAddressSearchTerm',value:function clearAddressSearchTerm(){this.setState({addressSearchTerm:''});}/**
   * Adds error to the state and clears departures
   * @param {string} error Error message
   */},{key:'onError',value:function onError(error){this.setState({error:error,loading:false,departures:[],filtered:[]});}/**
   * Hides the error message
   * @param {string} error Error message
   */},{key:'hideError',value:function hideError(){this.setState({error:null});}/**
   * Renders App
   * @returns {string} markup
   */},{key:'render',value:function render(){var _state2=this.state,filtered=_state2.filtered,filters=_state2.filters,error=_state2.error,location=_state2.location,addressSearchTerm=_state2.addressSearchTerm,loading=_state2.loading,departureUpdateTime=_state2.departureUpdateTime;return Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2,'div','app-content',[Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_3__components_header_header__["a" /* default */]),Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2,'main',null,[Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_7__components_errormessage_errormessage__["a" /* default */],null,null,{'message':error,'onClick':this.hideError.bind(this)}),Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_8__components_addresssearch_addresssearch__["a" /* default */],null,null,{'address':addressSearchTerm,'onSearch':this.searchForAddress.bind(this),'clearAddressSearchTerm':this.clearAddressSearchTerm.bind(this)}),location&&Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_14__components_common_accuracyindicator__["a" /* default */],null,null,{'accuracy':location.accuracy}),Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_6__components_departurefilter_departurefilter__["a" /* default */],null,null,{'filters':allVehicleTypes,'activeFilters':filters.vehicleTypes,'range':filters.range,'onFilterToggle':this.onFilterToggle.bind(this),'onRangeChange':this.onRangeChange.bind(this)}),Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_5__components_departureslist_departureslist__["a" /* default */],null,null,{'isLoading':loading,'departures':filtered})]),Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_4__components_footer_footer__["a" /* default */],null,null,{'departureUpdateTime':departureUpdateTime})]);}}]);return App;}(__WEBPACK_IMPORTED_MODULE_0_inferno_component___default.a);/* harmony default export */ __webpack_exports__["a"] = (App);
...
var _always = __webpack_require__(25);

var _always2 = _interopRequireDefault(_always);

var _and = __webpack_require__(26);
...
var _average = __webpack_require__(28);

var _average2 = _interopRequireDefault(_average);

var _between = __webpack_require__(29);
...
var _composeAll = __webpack_require__(39);
...
var _converge = __webpack_require__(41);

var _converge2 = _interopRequireDefault(_converge);

var _curry = __webpack_require__(42);

var _curry2 = _interopRequireDefault(_curry);

var _curryRight = __webpack_require__(43);

var _curryRight2 = _interopRequireDefault(_curryRight);

var _dec = __webpack_require__(44);

var _dec2 = _interopRequireDefault(_dec);

var _drop = __webpack_require__(45);

var _drop2 = _interopRequireDefault(_drop);

var _endsWith = __webpack_require__(46);

var _endsWith2 = _interopRequireDefault(_endsWith);

var _endsWithAt = __webpack_require__(47);

var _endsWithAt2 = _interopRequireDefault(_endsWithAt);

var _equal = __webpack_require__(48);

var _equal2 = _interopRequireDefault(_equal);

var _every = __webpack_require__(49);

var _every2 = _interopRequireDefault(_every);

var _exec = __webpack_require__(50);

var _exec2 = _interopRequireDefault(_exec);

var _explode = __webpack_require__(51);
...
var _flatMap = __webpack_require__(53);

var _flatMap2 = _interopRequireDefault(_flatMap);

var _flip = __webpack_require__(54);

var _flip2 = _interopRequireDefault(_flip);

var _fold = __webpack_require__(55);

var _fold2 = _interopRequireDefault(_fold);

var _foldRight = __webpack_require__(56);

var _foldRight2 = _interopRequireDefault(_foldRight);

var _forEach = __webpack_require__(57);

var _forEach2 = _interopRequireDefault(_forEach);

var _greaterOrEqual = __webpack_require__(58);

var _greaterOrEqual2 = _interopRequireDefault(_greaterOrEqual);

var _greaterThan = __webpack_require__(59);

var _greaterThan2 = _interopRequireDefault(_greaterThan);

var _hasOwnProperty = __webpack_require__(60);

var _hasOwnProperty2 = _interopRequireDefault(_hasOwnProperty);

var _head = __webpack_require__(61);
...
var _ifThen = __webpack_require__(63);

var _ifThen2 = _interopRequireDefault(_ifThen);

var _ifThenElse = __webpack_require__(64);

var _ifThenElse2 = _interopRequireDefault(_ifThenElse);

var _implode = __webpack_require__(65);

var _implode2 = _interopRequireDefault(_implode);

var _inc = __webpack_require__(66);

var _inc2 = _interopRequireDefault(_inc);

var _includes = __webpack_require__(67);

var _includes2 = _interopRequireDefault(_includes);

var _indexOf = __webpack_require__(68);

var _indexOf2 = _interopRequireDefault(_indexOf);

var _isBetween = __webpack_require__(69);

var _isBetween2 = _interopRequireDefault(_isBetween);

var _isBoolean = __webpack_require__(70);

var _isBoolean2 = _interopRequireDefault(_isBoolean);

var _isFalse = __webpack_require__(71);

var _isFalse2 = _interopRequireDefault(_isFalse);

var _isFalsy = __webpack_require__(72);
...
var _isNull = __webpack_require__(74);

var _isNull2 = _interopRequireDefault(_isNull);

var _isNumber = __webpack_require__(75);

var _isNumber2 = _interopRequireDefault(_isNumber);

var _isObject = __webpack_require__(76);
...
var _isTrue = __webpack_require__(79);

var _isTrue2 = _interopRequireDefault(_isTrue);

var _isTruthy = __webpack_require__(80);

var _isTruthy2 = _interopRequireDefault(_isTruthy);

var _isTypeOf = __webpack_require__(81);

var _isTypeOf2 = _interopRequireDefault(_isTypeOf);

var _isUndefined = __webpack_require__(82);

var _isUndefined2 = _interopRequireDefault(_isUndefined);

var _isUnknown = __webpack_require__(83);

var _isUnknown2 = _interopRequireDefault(_isUnknown);

var _join = __webpack_require__(84);
...
var _last = __webpack_require__(86);

var _last2 = _interopRequireDefault(_last);

var _lastIndexOf = __webpack_require__(87);
...
var _lessOrEqual = __webpack_require__(89);

var _lessOrEqual2 = _interopRequireDefault(_lessOrEqual);

var _lessThan = __webpack_require__(90);

var _lessThan2 = _interopRequireDefault(_lessThan);

var _localeCompare = __webpack_require__(91);

var _localeCompare2 = _interopRequireDefault(_localeCompare);

var _looseEqual = __webpack_require__(92);
...
var _match = __webpack_require__(94);

var _match2 = _interopRequireDefault(_match);

var _max = __webpack_require__(95);

var _max2 = _interopRequireDefault(_max);

var _method = __webpack_require__(96);

var _method2 = _interopRequireDefault(_method);

var _min = __webpack_require__(97);

var _min2 = _interopRequireDefault(_min);

var _minus = __webpack_require__(98);

var _minus2 = _interopRequireDefault(_minus);

var _nand = __webpack_require__(99);
...
var _nor = __webpack_require__(101);
...
var _not = __webpack_require__(103);

var _not2 = _interopRequireDefault(_not);

var _nth = __webpack_require__(104);

var _nth2 = _interopRequireDefault(_nth);

var _omit = __webpack_require__(105);

var _omit2 = _interopRequireDefault(_omit);

var _or = __webpack_require__(106);

var _or2 = _interopRequireDefault(_or);

var _pick = __webpack_require__(107);

var _pick2 = _interopRequireDefault(_pick);

var _pipe = __webpack_require__(108);

var _pipe2 = _interopRequireDefault(_pipe);

var _pipeAll = __webpack_require__(109);

var _pipeAll2 = _interopRequireDefault(_pipeAll);

var _plus = __webpack_require__(110);
...
var _property = __webpack_require__(112);

var _property2 = _interopRequireDefault(_property);

var _push = __webpack_require__(113);

var _push2 = _interopRequireDefault(_push);

var _put = __webpack_require__(114);

var _put2 = _interopRequireDefault(_put);

var _reduce = __webpack_require__(115);

var _reduce2 = _interopRequireDefault(_reduce);

var _reduceRight = __webpack_require__(116);

var _reduceRight2 = _interopRequireDefault(_reduceRight);

var _repeat = __webpack_require__(117);

var _repeat2 = _interopRequireDefault(_repeat);

var _replace = __webpack_require__(118);
...
var _shallowClone = __webpack_require__(120);

var _shallowClone2 = _interopRequireDefault(_shallowClone);

var _shave = __webpack_require__(121);

var _shave2 = _interopRequireDefault(_shave);

var _signum = __webpack_require__(122);

var _signum2 = _interopRequireDefault(_signum);

var _slice = __webpack_require__(123);

var _slice2 = _interopRequireDefault(_slice);

var _some = __webpack_require__(124);

var _some2 = _interopRequireDefault(_some);

var _split = __webpack_require__(125);

var _split2 = _interopRequireDefault(_split);

var _startsWith = __webpack_require__(126);

var _startsWith2 = _interopRequireDefault(_startsWith);

var _startsWithAt = __webpack_require__(127);

var _startsWithAt2 = _interopRequireDefault(_startsWithAt);

var _sum = __webpack_require__(128);

var _sum2 = _interopRequireDefault(_sum);

var _tail = __webpack_require__(129);

var _tail2 = _interopRequireDefault(_tail);

var _take = __webpack_require__(130);

var _take2 = _interopRequireDefault(_take);

var _takeUntil = __webpack_require__(131);

var _takeUntil2 = _interopRequireDefault(_takeUntil);

var _takeWhile = __webpack_require__(132);

var _takeWhile2 = _interopRequireDefault(_takeWhile);

var _test = __webpack_require__(133);

var _test2 = _interopRequireDefault(_test);

var _times = __webpack_require__(134);

var _times2 = _interopRequireDefault(_times);

var _toLowerCase = __webpack_require__(135);

var _toLowerCase2 = _interopRequireDefault(_toLowerCase);

var _toUpperCase = __webpack_require__(136);

var _toUpperCase2 = _interopRequireDefault(_toUpperCase);

var _trim = __webpack_require__(137);

var _trim2 = _interopRequireDefault(_trim);

var _uncurry = __webpack_require__(138);

var _uncurry2 = _interopRequireDefault(_uncurry);

var _uncurry3 = __webpack_require__(139);

var _uncurry32 = _interopRequireDefault(_uncurry3);

var _unfold = __webpack_require__(140);
...
var _xor = __webpack_require__(142);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__header_css__ = __webpack_require__(144);
 ...
 * @constructs Header
 *//* harmony default export */ __webpack_exports__["a"] = (function(){return Object(__WEBPACK_IMPORTED_MODULE_2_inferno__["createVNode"])(2,'header',null,[Object(__WEBPACK_IMPORTED_MODULE_2_inferno__["createVNode"])(2,'h1',null,[Object(__WEBPACK_IMPORTED_MODULE_2_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_1__common_vehicleicon__["a" /* default */],null,null,{'iconName':'bus'}),Object(__WEBPACK_IMPORTED_MODULE_2_inferno__["createVNode"])(2,'span','app-name','julkisilla.info')]),Object(__WEBPACK_IMPORTED_MODULE_2_inferno__["createVNode"])(2,'p','app-description','L\xF6yd\xE4 l\xE4himm\xE4t julkisen liikenteen l\xE4hd\xF6t helposti')]);});
...
module.exports = __webpack_require__.p + "static/media/icons.50d259c7.svg";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__footer_css__ = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inferno_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_inferno_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__departurerow__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__loadingoverlay_loadingoverlay__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__departureslistsortheader__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_departuresorter__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__departureslist_css__ = __webpack_require__(158);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routeidentifier__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__distance__ = __webpack_require__(152);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__spinner_svg__ = __webpack_require__(154);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__loadingoverlay_css__ = __webpack_require__(155);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fputils__ = __webpack_require__(2);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__filterbutton__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rangefilter__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__departurefilter_css__ = __webpack_require__(162);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_vehicleicon__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inferno__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_inferno__);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inferno___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_inferno__);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errormessage_css__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__suggestionslist__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_addresssearchservice__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constants_constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addresssearch_css__ = __webpack_require__(180);
 ...
 */var AddressSearch=function(_Component){_inherits(AddressSearch,_Component);/**
   ...
   * @param {Object} props
   * @param {string} address
   */function AddressSearch(props){_classCallCheck(this,AddressSearch);var _this=_possibleConstructorReturn(this,(AddressSearch.__proto__||Object.getPrototypeOf(AddressSearch)).call(this,props));_this.state={searchTerm:props.address,suggestions:[]};_this.debouncedFetchSuggestions=__WEBPACK_IMPORTED_MODULE_0_lodash_debounce___default()(_this.fetchSuggestions,300);return _this;}/**
   * Address changes when location search succeeds
   * @param {Object} newProps
   * @param {string} newProps.address
   */_createClass(AddressSearch,[{key:'componentWillReceiveProps',value:function componentWillReceiveProps(newProps){// only update when address actually changes so
// it won't override text written to the input
if(newProps.address!==this.props.address){this.setState({searchTerm:newProps.address,selectedSuggestion:undefined});if(!newProps.address){this.addressInput.focus();}}}/**
   * Does submit action (calls given callback) and
   * does suggestions clean up
   */},{key:'doSubmitAction',value:function doSubmitAction(){var _state=this.state,searchTerm=_state.searchTerm,selectedSuggestion=_state.selectedSuggestion;this.hideSuggestions();// if a suggestion is selected then use that
// as search term otherwise find address based on search term
var param=selectedSuggestion?{location:selectedSuggestion.location,searchTerm:selectedSuggestion.label}:{searchTerm:searchTerm};this.props.onSearch(param);}/**
   * Set suggestion selected
   * @param {Object} suggestion
   */},{key:'selectSuggestion',value:function selectSuggestion(suggestion){this.setState({selectedSuggestion:suggestion,searchTerm:suggestion.label});}/**
   * Select next suggestion. Callback for down arrow button.
   */},{key:'selectNextSuggestion',value:function selectNextSuggestion(){var _state2=this.state,suggestions=_state2.suggestions,selectedSuggestion=_state2.selectedSuggestion;var currentIndex=suggestions.indexOf(selectedSuggestion);var nextIndex=currentIndex+1>=suggestions.length?0:currentIndex+1;this.selectSuggestion(suggestions[nextIndex]);}/**
   * Select previous suggestion. Callback for up arrow button.
   */},{key:'selectPrevSuggestion',value:function selectPrevSuggestion(){var _state3=this.state,suggestions=_state3.suggestions,selectedSuggestion=_state3.selectedSuggestion;var currentIndex=suggestions.indexOf(selectedSuggestion);var prevIndex=[-1,0].indexOf(currentIndex)>-1?suggestions.length-1:currentIndex-1;this.selectSuggestion(suggestions[prevIndex]);}/**
   * Fetch suggestions from api
   * @param {string} searchTerm
   */},{key:'fetchSuggestions',value:function fetchSuggestions(searchTerm){var _this2=this;Object(__WEBPACK_IMPORTED_MODULE_3__services_addresssearchservice__["b" /* searchAddress */])(searchTerm,__WEBPACK_IMPORTED_MODULE_4__constants_constants__["d" /* MAX_ADDRESS_SUGGESTIONS */]).then(function(result){return result.sort(function(a,b){return b.confidence-a.confidence;});}).then(function(sorted){return _this2.setState({suggestions:sorted});}).catch(function(e){return console.log(e);});}/**
  ...
  */},{key:'onSubmit',value:function onSubmit(e){e.preventDefault();this.doSubmitAction();}},{key:'onClearClick',value:function onClearClick(e){e.preventDefault();this.props.clearAddressSearchTerm();}/**
...
case 38:e.preventDefault();this.selectPrevSuggestion();break;// if down was pressed
case 40:e.preventDefault();this.selectNextSuggestion();break;// if esc was pressed
case 27:e.preventDefault();this.hideSuggestions();break;default:break;}}/**
   * Render component
   * @returns {string} markup
   */},{key:'render',value:function render(){var _this3=this;var _state4=this.state,searchTerm=_state4.searchTerm,suggestions=_state4.suggestions,selectedSuggestion=_state4.selectedSuggestion;return Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(2,'form',null,[Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(2,'div','address-search',[Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(512,'input',null,null,{'type':'text','aria-autocomplete':'list','aria-owns':'suggestions-list','aria-label':'Osoite/sijainti','placeholder':'Hae paikannuksella, osoitteella tai paikannimell\xE4...','onInput':this.onSearchTermChange.bind(this),'onBlur':this.hideSuggestions.bind(this),'value':searchTerm},null,function(c){return _this3.addressInput=c;}),Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(2,'button','address-search-clear',Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(2,'span',null,'x'),{'type':'button','onClick':this.onClearClick.bind(this)}),Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(2,'button','address-search-submit','Hae',{'type':'submit'})]),Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(2,'div','suggestions',Object(__WEBPACK_IMPORTED_MODULE_6_inferno__["createVNode"])(16,__WEBPACK_IMPORTED_MODULE_2__suggestionslist__["a" /* default */],null,null,{'suggestions':suggestions,'selected':selectedSuggestion,'onItemClick':this.onSuggestionClick.bind(this)}))],{'onSubmit':this.onSubmit.bind(this),'onKeyUp':this.onKeyEvent.bind(this)});}}]);return AddressSearch;}(__WEBPACK_IMPORTED_MODULE_1_inferno_component___default.a);/* harmony default export */ __webpack_exports__["a"] = (AddressSearch);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__suggestionslistitem__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__suggestionslist_css__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fputils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constants_constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_departuresservice__ = __webpack_require__(182);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_fputils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_graphqlresponseparser__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__querynearest__ = __webpack_require__(184);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__querybatch__ = __webpack_require__(185);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_utils__ = __webpack_require__(1);
 ...
 */function onLocationResult(resolve){/**
     ...
     */return function(position){stopLocating(watcherId);resolve(position);};};var findGPSLocation=function(){var _ref2=_asyncToGenerator(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(){var position;return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(navigator.geolocation){_context2.next=2;break;}throw new Error('Selain ei tue paikannusta');case 2:if(watcherId){_context2.next=7;break;}_context2.next=5;return getCurrentPosition();case 5:position=_context2.sent;return _context2.abrupt('return',position.coords);case 7:case'end':return _context2.stop();}}},_callee2,this);}));return function findGPSLocation(){return _ref2.apply(this,arguments);};}();/**
...
/* harmony export (immutable) */ __webpack_exports__["b"] = formatError;
/**
 ...
 */function formatError(type,error){if(type===POSITION_ERROR){return'Sijainti ei ole saatavilla: '+POSITION_ERROR_CODES[error.code]+'.';}}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__accuracyindicator_css__ = __webpack_require__(189);
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.9446e5a7.js.map